...
<html>
    ...
    <body> 
        <hr>
		<b><center>Laporan Register Peserta Didik Baru Tahun 2022</center></b>
		...
		<br>
            ...
            <tr>
                <td style="text-align: center">
                    <font size="1">
                        <img class="img" src="temp/<?= $siswa['nisn'] ?>.png" ec="H" style="width: 20mm; background-color: white; color: black;">
                    </font>
                </td>
				...
				<td style="text-align: center">
                    <font size="2">
						...
						<img class="img" src="../../<?= $siswa['foto'] ?>" ec="H" style="width: 20mm;hight: 20mm; background-color: white; color: black;">
