...
<font face="arial">
	...
	<table style="width:100%">
		<tr>
			...
			<td colspan='2' align='center'>
					...
					<b>LAPORAN SELEKSI  DATA SISWA</b>
	...
	<table border='0' width='95%' align='center'>
		<tr height='30'>
			<td height='30' colspan='4' style='text-align: justify;'>Laporan Seleksi Data Siswa Baru Tahun Pelajaran<b> <?php echo date("Y");?> / <?php echo date('Y', mktime( 0, 0, 0, date('n'), date('j'), date('y') + 1));?></b> pada madrasah <b><?= $setting['nama_sekolah'] ?></b></td>
		</tr>
	</table>
	<br>
