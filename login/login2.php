...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/favicon-16x16.png">
    <link rel="icon" type="image/png" sizes="512x512"
        href="https://rdm.hdmadrasah.id/assets/images/favicon/ms-icon-512x512.png">
...
<body style="background-color: #666666;">
    ...
    <div class="pre-loader">
        <div class="pre-loader-box">
            <div class="loader-logo"><img src="https://rdm.hdmadrasah.id/assets/images/brand/round-logo.png" alt="">
            </div>
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 text-right">
                                    <a class="btn btn-link px-2" target="__downloadpage"
                                        href="https://hdmadrasah.id/download">Download Aplikasi</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="login100-more"
                    style="background-image: url('https://rdm.hdmadrasah.id/assets/images/bg-01.png');">
                </div>
            </div>
        </div>
    </div>
