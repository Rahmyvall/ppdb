                                            ...
                                            <form id="form-daftar">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <input class="form-control" type="hidden" name="kodepengaman" value="abcd" placeholder="masukan kode" required>
                                                        </div>
                                            ...
                                            <form id="form-daftar">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <input class="form-control" type="hidden" name="kodepengaman" value="abcd" placeholder="masukan kode" disabled>
                                                        </div>
