...
?>
  ...
  <body>
    <div id="app">
      <div class="chating" style=" z-index: 99999; width: 50px; padding: 15px;  bottom: 0; position: fixed; ">
        <a href="https://api.whatsapp.com/send?phone=+62<?= $setting['nolivechat'] ?>&text=<?= $setting['livechat'] ?>">
          ...
          <img src="../assets/img/wa.png" width="150">
        </a>
      </div>
      <div class="main-wrapper main-wrapper-1">
        ...
        <script>
          ...
          $(function() {
            setInterval(timestamp,
              1000
            ); //fungsi yang dijalan setiap detik, 1000 = 1 detik
          });
        ...
        <body>
                ...
                <aside id="sidebar-wrapper">
                  ...
                  <div class="menu-header">
                    ...
                    <ul>
                      ...
                      <li>
                        <a style="color:#f27907" href="logout.php" class="btn-logout">
                          <span class="fa fa-sign-out-alt  "></span><br>Keluar</a>
                      </li>
                    </ul>
                  </div>
          ...
          <script src="../assets/modules/popper.js">
          </script>
          <script src="../assets/modules/tooltip.js">
          </script>
          <script src="../assets/modules/bootstrap/js/bootstrap.min.js">
          </script>
          <script src="../assets/modules/nicescroll/jquery.nicescroll.min.js">
          </script>
          <script src="../assets/modules/moment.min.js">
          </script>
    ...
    <script src="../assets/modules/chocolat/dist/js/jquery.chocolat.min.js"></script> -->
          ...
          <!-- JS DATATABLE -->
          <script src="../assets/modules/datatables/datatables.min.js">
          </script>
          <script src="../assets/modules/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js">
          </script>
          <script src="../assets/modules/datatables/Select-1.2.4/js/dataTables.select.min.js">
          </script>
          <script src="../assets/modules/jquery-ui/jquery-ui.min.js">
          </script>

          <!-- Page Specific DATATABLE -->
          <script src="../assets/js/page/modules-datatables.js">
          </script>
          <script src="../assets/modules/select2/dist/js/select2.full.min.js">
          </script>
          <script src="../assets/modules/bootstrap-daterangepicker/daterangepicker.js">
          </script>
          <script src="../assets/modules/summernote/summernote-bs4.js">
          </script>
